...
$path_prefix = '../';
$extra_head = <<<'EOD'
<link rel="canonical" href="https://drsujitchowdhary.com/blog/hydronephrosis-in-children.php">
  ...
  "@graph": [
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://drsujitchowdhary.com/blog/hydronephrosis-in-children.php"
      }
    },
    {
      "@type": "MedicalWebPage",
...
<div class="page-header">
    <div class="container fade-in-up">
        <h1>Hydronephrosis in Children | Symptoms, Diagnosis & Treatment</h1>
        <div class="breadcrumb">
            <a href="../index.php">Home</a> <span>/</span> <a href="../blog.php">Blog</a> <span>/</span> <span>Hydronephrosis in Children</span>
        </div>
        <div class="blog-meta-bar">
            <span><i class="fas fa-calendar-alt"></i> Published: 12 August 2026</span>
...
<section class="section">
    <div class="container blog-container">
        ...
        <article class="blog-content fade-in-up">
            ...
            <img src="../assets/images/blog/hydronephrosis-in-children.jpg" alt="Hydronephrosis in Children Symptoms, Diagnosis & Treatment - Healthy Kidney vs Hydronephrosis Diagram" style="width: 100%; height: auto; border-radius: var(--radius-lg); margin-bottom: 30px; box-shadow: var(--shadow-md); object-fit: cover; max-height: 480px; background: #fff;">
            ...
            <ul>
                <li><strong>Pelviureteric Junction Obstruction (PUJO):</strong> The most common cause of single-kidney (unilateral) hydronephrosis in infants. A structural narrowing occurs where the renal pelvis connects to the ureter, restricting urine flow out of the kidney. Read our in-depth guide on <strong><a href="causes-of-pelvi-ureteric-junction-obstruction-in-children.php">causes of Pelvi Ureteric Junction Obstruction in children</a></strong> or explore specialized <strong><a href="../service/pujo.php">Pelviureteric Junction Obstruction (PUJO) Surgery</a></strong> options.</li>
            ...
            <div class="faq-accordion mt-4" id="faq-section">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What is hydronephrosis in children?</h5>
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>How is hydronephrosis diagnosed in infants?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
        ...
        <div class="grid-2 align-items-center">
            <div class="contact-form-wrapper card fade-in-up">
                <div class="section-title text-left mb-4">
                    ...
                    <p>Early identification of hydronephrosis in children prevents long-term kidney complications. Schedule a consultation with Dr. Sujit Chowdhary today.</p>
                </div>
