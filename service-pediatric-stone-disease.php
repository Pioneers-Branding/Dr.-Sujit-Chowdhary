    ...
    <li><i class="fas fa-check-circle" style="color: var(--secondary-teal); margin-right: 8px;"></i> <strong>UTIs & Fever:</strong> High fever and chills indicating a stone block paired with infection.</li>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-pediatric-stone-disease.php" class="active">Pediatric Endourology & Stones</a></li>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"Dr. Chowdhary's approach to childhood stone prevention through metabolic testing is very scientific and has helped prevent recurrence."</p>
                    <div class="author mt-3">
                        <h5>Sanjay Dixit</h5>
                        <span>Father</span>
                    </div>
            ...
            <div class="faq-accordion fade-in-up mt-5">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>Are kidney stones common in children?</h5>
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Stitchless endourology and laser therapy safely clear pediatric kidney stones. Schedule a consultation today.</p>
                    </div>
