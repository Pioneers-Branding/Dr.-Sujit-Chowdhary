...
<h3 class="mt-4">Why Early Intervention Matters</h3>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-exstrophy-epispadias.php" class="active">Exstrophy Epispadias</a></li>
                </ul>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"The dedication Dr. Chowdhary shows to exstrophy patients is incredible. His step-by-step reconstruction plan gave our child a normal life."</p>
                    <div class="author mt-3">
                        <h5>Harish Pal</h5>
                        <span>Father</span>
                    </div>
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Staged functional reconstruction helps children with bladder exstrophy achieve continence. Schedule a consultation today.</p>
                    </div>
