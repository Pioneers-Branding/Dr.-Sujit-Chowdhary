    ...
    <li><i class="fas fa-check-circle" style="color: var(--secondary-teal); margin-right: 8px;"></i> <strong>Systemic Signs:</strong> Persistent fever, fatigue, weight loss, and poor appetite.</li>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-pediatric-tumors.php" class="active">Pediatric Tumors</a></li>
                </ul>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"Compassionate, scientific, and highly skilled. Dr. Sujit guided us through every step of tumor resection and pediatric ICU recovery."</p>
                    <div class="author mt-3">
                        <h5>Anil Sharma</h5>
                        <span>Father</span>
                    </div>
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Expert multi-disciplinary surgical removal of solid tumors protects your child's growth. Schedule a consultation today.</p>
                    </div>
