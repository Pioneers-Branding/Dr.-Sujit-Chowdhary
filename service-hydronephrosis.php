<?php
$page_title = 'Hydronephrosis Treatment in Delhi | Dr. Sujit Chowdhary';
...
<h3 class="mt-4">Why Early Intervention Matters</h3>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-hydronephrosis.php" class="active">Hydronephrosis</a></li>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card">
                    ...
                    <p class="quote">"Expert hands! Dr. Sujit's diagnostic clarity saved our son's kidney function. The recovery was much faster than we expected. Thank you, Doctor."</p>
                    <div class="author mt-3">
                        <h5>Aarti S.</h5>
                        <span>Mother</span>
                    </div>
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Early diagnosis and treatment of hydronephrosis is key to saving kidney function. Schedule a consultation today.</p>
                    </div>
