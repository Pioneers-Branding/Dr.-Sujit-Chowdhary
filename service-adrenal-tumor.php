    ...
    <li><i class="fas fa-check-circle" style="color: var(--secondary-teal); margin-right: 8px;"></i> <strong>Hypertension:</strong> High blood pressure, sweating, and heart palpitations (typical of pheochromocytoma).</li>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-adrenal-tumor.php" class="active">Adrenal Tumor</a></li>
                </ul>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"Dr. Chowdhary's expertise in robotic adrenalectomy is outstanding. The keyhole incisions healed beautifully, and recovery was incredibly fast."</p>
                    <div class="author mt-3">
                        <h5>Preeti M.</h5>
                        <span>Mother</span>
                    </div>
            ...
            <div class="faq-accordion fade-in-up mt-5">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>Are adrenal tumors in children always cancerous?</h5>
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Surgical removal of adrenal tumors is key to protecting your child's health. Schedule a consultation today.</p>
                    </div>
