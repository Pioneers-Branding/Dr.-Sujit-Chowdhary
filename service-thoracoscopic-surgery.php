    ...
    <li><i class="fas fa-check-circle" style="color: var(--secondary-teal); margin-right: 8px;"></i> <strong>Chest Pain & Cough:</strong> Persistent coughing or pain, especially with breathing.</li>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-thoracoscopic-surgery.php" class="active">Thoracoscopic Surgery</a></li>
                </ul>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"Dr. Chowdhary's minimally invasive approach to childhood chest conditions is world-class. Our son's lung function is completely normal now."</p>
                    <div class="author mt-3">
                        <h5>Vikram Dev</h5>
                        <span>Father</span>
                    </div>
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Keyhole chest surgery avoids muscle damage and leads to quick recovery. Schedule a consultation today.</p>
                    </div>
