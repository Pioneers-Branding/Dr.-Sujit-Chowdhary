            ...
            <div class="grid-3 mt-5">
                ...
                <div class="card fade-in-up" style="padding: 0; overflow: hidden;">
                    <div style="height: 200px; overflow: hidden;">
                        <img src="assets/images/blog/causes-of-pelvi-ureteric-junction-obstruction-in-children.jpg" alt="Causes of Pelvi Ureteric Junction Obstruction in Children" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div style="padding: 25px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            <span style="color: var(--secondary-teal); font-weight: 600; font-size: 0.85rem;">Pediatric Urology</span>
                            <span style="color: #777; font-size: 0.8rem;"><i class="fas fa-calendar-alt"></i> 25 Sep 2026</span>
                        </div>
                        <h3 style="font-size: 1.2rem; line-height: 1.4;">Causes of Pelvi Ureteric Junction Obstruction in Children</h3>
                        <p class="mt-2" style="font-size: 0.9rem; color: #555;">Learn about the primary causes of PUJO in infants and older children, intrinsic muscle defects, crossing blood vessels, symptoms, and robotic pyeloplasty...</p>
                        <a href="blog/causes-of-pelvi-ureteric-junction-obstruction-in-children.php" class="btn btn-outline mt-3" style="padding: 8px 15px; font-size: 0.9rem;">Read More</a>
                    </div>
                </div>

                <!-- Featured Blog Card (Antenatal ARM Diagnosis) -->
                <div class="card fade-in-up" style="padding: 0; overflow: hidden;">
                    <div style="height: 200px; overflow: hidden;">
                        <img src="assets/images/blog/can-anorectal-malformation-be-diagnosed-antenatally.jpg" alt="Can Anorectal Malformation be diagnosed Antenatally?" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div style="padding: 25px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            <span style="color: var(--secondary-teal); font-weight: 600; font-size: 0.85rem;">Pediatric Surgery</span>
                            <span style="color: #777; font-size: 0.8rem;"><i class="fas fa-calendar-alt"></i> 20 Sep 2026</span>
                        </div>
                        <h3 style="font-size: 1.2rem; line-height: 1.4;">Can Anorectal Malformation be diagnosed Antenatally?</h3>
                        <p class="mt-2" style="font-size: 0.9rem; color: #555;">Learn whether imperforate anus / ARM can be diagnosed during pregnancy ultrasound, key sonographic markers, fetal MRI, and expert surgical planning...</p>
                        <a href="blog/can-anorectal-malformation-be-diagnosed-antenatally.php" class="btn btn-outline mt-3" style="padding: 8px 15px; font-size: 0.9rem;">Read More</a>
                    </div>
                </div>
                ...
                <div class="card fade-in-up" style="padding: 0; overflow: hidden;">
                    <div style="height: 200px; overflow: hidden;">
                        <img src="assets/images/blog/can-a-child-of-5-years-suffer-from-hernia.jpg" alt="Can a child of 5 Years suffer from Hernia?" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div style="padding: 25px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            <span style="color: var(--secondary-teal); font-weight: 600; font-size: 0.85rem;">Pediatric Surgery</span>
                        ...
                        <a href="blog/can-a-child-of-5-years-suffer-from-hernia.php" class="btn btn-outline mt-3" style="padding: 8px 15px; font-size: 0.9rem;">Read More</a>
                    </div>
                </div>

                <!-- Featured Blog Card (Choledochal Cyst) -->
                <div class="card fade-in-up" style="padding: 0; overflow: hidden;">
                    <div style="height: 200px; overflow: hidden;">
                        <img src="assets/images/blog/choledochal-cyst-in-child.jpg" alt="Choledochal Cyst in Child: Symptoms, Causes and Treatment" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div style="padding: 25px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            <span style="color: var(--secondary-teal); font-weight: 600; font-size: 0.85rem;">Pediatric Surgery</span>
                        ...
                        <a href="blog/choledochal-cyst-in-child.php" class="btn btn-outline mt-3" style="padding: 8px 15px; font-size: 0.9rem;">Read More</a>
                    </div>
                </div>
                <!-- Featured Blog Card (Adrenal Tumor) -->
                <div class="card fade-in-up" style="padding: 0; overflow: hidden;">
                    <div style="height: 200px; overflow: hidden;">
                        <img src="assets/images/blog/how-to-recognize-adrenal-tumor-symptoms-in-children.png" alt="How to Recognize Adrenal Tumor Symptoms in Children?" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div style="padding: 25px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            <span style="color: var(--secondary-teal); font-weight: 600; font-size: 0.85rem;">Pediatric Oncology</span>
                            <span style="color: #777; font-size: 0.8rem;"><i class="fas fa-calendar-alt"></i> 30 Aug 2026</span>
                        </div>
                        <h3 style="font-size: 1.2rem; line-height: 1.4;">How to Recognize Adrenal Tumor Symptoms in Children?</h3>
                        <p class="mt-2" style="font-size: 0.9rem; color: #555;">Learn key symptoms of pediatric adrenal tumors, virilization, Cushing syndrome, high blood pressure, abdominal mass, and expert surgical care...</p>
                        <a href="blog/how-to-recognize-adrenal-tumor-symptoms-in-children.php" class="btn btn-outline mt-3" style="padding: 8px 15px; font-size: 0.9rem;">Read More</a>
                    </div>
                </div>
