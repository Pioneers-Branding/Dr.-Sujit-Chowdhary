            ...
            <div class="grid-2 mt-5">
                ...
                <div class="card fade-in-up" style="padding: 0; overflow: hidden;">
                    ...
                    <div style="padding: 25px;">
                        ...
                        <h3 style="font-size: 1.3rem; line-height: 1.4;">Hydronephrosis in Children | Symptoms, Diagnosis & Treatment</h3>
                        <p class="mt-2" style="font-size: 0.95rem; color: #555;">Learn about pediatric hydronephrosis, causes like PUJO and VUR, symptoms, ultrasound grading, and robotic treatment options...</p>
                ...
                <div class="card fade-in-up" style="animation-delay: 0.1s; padding: 0; overflow: hidden;">
                    ...
                    <div style="padding: 25px;">
                        ...
                        <h3 style="font-size: 1.3rem; line-height: 1.4;">Causes of Red Urine in a Child? {Complete Guide}</h3>
                        <p class="mt-2" style="font-size: 0.95rem; color: #555;">Learn about benign dietary causes and clinical causes of red blood cells in urine (hematuria), symptoms, and treatment...</p>
