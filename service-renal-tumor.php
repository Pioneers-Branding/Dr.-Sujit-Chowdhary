...
<h3 class="mt-4">Why Early Intervention Matters</h3>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-renal-tumor.php" class="active">Renal Tumor</a></li>
                </ul>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card">
                    ...
                    <p class="quote">"We traveled from abroad for our child's surgery. Dr. Chowdhary's reputation is well-deserved; he is a true expert in pediatric oncology surgery."</p>
                    <div class="author mt-3">
                        <h5>Michael D.</h5>
                        <span>Parent</span>
                    </div>
    ...
    <section class="section bg-light" id="faq">
        <div class="container">
            ...
            <div class="faq-accordion fade-in-up mt-5">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What is the role of chemotherapy in Wilms tumor treatment?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Surgical resection of Wilms tumor is highly effective and saves lives. Schedule a consultation today.</p>
                    </div>
