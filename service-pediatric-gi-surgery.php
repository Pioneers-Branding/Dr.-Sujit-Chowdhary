    ...
    <li><i class="fas fa-check-circle" style="color: var(--secondary-teal); margin-right: 8px;"></i> <strong>Failure to Thrive:</strong> Significant weight loss or inability to gain weight due to digestive tract dysfunction.</li>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-pediatric-gi-surgery.php" class="active">Pediatric Gastrointestinal Surgery</a></li>
                </ul>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"Dr. Chowdhary is a pioneer in pediatric GI reconstruction. His calm confidence and detailed explanations gave us so much peace of mind."</p>
                    <div class="author mt-3">
                        <h5>Rajesh S.</h5>
                        <span>Father</span>
                    </div>
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Congenital gastrointestinal conditions are treated with high success using modern methods. Schedule a consultation today.</p>
                    </div>
