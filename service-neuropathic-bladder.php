<?php
$page_title = 'Neuropathic Bladder Treatment in Delhi | Dr. Sujit Chowdhary';
...
<h3 class="mt-4">Why Early Intervention Matters</h3>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-neuropathic-bladder.php" class="active">Neuropathic Bladder</a></li>
    ...
    <section class="section">
        <div class="container">
            <div class="section-title fade-in-up">
                <h4 class="accent-text">The Clinical Journey</h4>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card">
                    ...
                    <p class="quote">"Dr. Chowdhary's knowledge of neurogenic bladder management is world-class. He saved our child's kidneys from severe reflux damage."</p>
                    <div class="author mt-3">
                        <h5>S. Lakshman</h5>
                        <span>Father</span>
                    </div>
    ...
    <section class="section bg-light" id="faq">
        <div class="container">
            ...
            <div class="faq-accordion fade-in-up mt-5">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What is Clean Intermittent Catheterization (CIC)?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What is a Mitrofanoff procedure?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Early management of neuropathic bladder protects the kidneys and achieves dryness. Schedule a consultation today.</p>
                    </div>
