    ...
    <li><i class="fas fa-check-circle" style="color: var(--secondary-teal); margin-right: 8px;"></i> <strong>Interrupted Stream:</strong> Dribbling, straining, or a start-and-stop stream during voiding.</li>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-voiding-dysfunction.php" class="active">Voiding Dysfunction</a></li>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"Highly professional and empathetic. Treating voiding dysfunction in kids needs patience, and Dr. Chowdhary has plenty of it."</p>
                    <div class="author mt-3">
                        <h5>Madan Lal</h5>
                        <span>Father</span>
                    </div>
            ...
            <div class="faq-accordion fade-in-up mt-5">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What is pediatric voiding dysfunction?</h5>
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What causes voiding dysfunction in children?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Bladder rehabilitation and biofeedback successfully cure daytime wetting and urgency. Schedule a consultation today.</p>
                    </div>
