...
<h3 class="mt-4">Why Early Intervention Matters</h3>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-hirschsprung.php" class="active">Hirschsprung</a></li>
                </ul>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card">
                    ...
                    <p class="quote">"Dr. Chowdhary is a lifesaver. He handled our newborn's surgery with such expertise. The clarity he gave us about the procedure was very reassuring."</p>
                    <div class="author mt-3">
                        <h5>Priyanka S.</h5>
                        <span>Mother</span>
                    </div>
    ...
    <section class="section bg-light" id="faq">
        <div class="container">
            ...
            <div class="faq-accordion fade-in-up mt-5">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What is Hirschsprung-associated enterocolitis (HAEC)?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Minimally invasive pull-through surgery restores normal bowel passage for your child. Schedule a consultation today.</p>
                    </div>
