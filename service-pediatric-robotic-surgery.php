    ...
    <li><i class="fas fa-check-circle" style="color: var(--secondary-teal); margin-right: 8px;"></i> <strong>Recurrent Kidney Infections:</strong> Accompanied by high fevers and flank pain.</li>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-pediatric-robotic-surgery.php" class="active">Pediatric Robotic Surgery</a></li>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.1s">
                    ...
                    <p class="quote">"Robotic ureteral reimplantation was done for our daughter's reflux. She was discharged within 48 hours and is doing great. Amazing technology and expertise."</p>
                    <div class="author mt-3">
                        <h5>Swati S.</h5>
                        <span>Mother</span>
                    </div>
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"Dr. Sujit Chowdhary is a master of pediatric robotic surgery. His precision is unmatched, and his explanation of the procedure was very thorough."</p>
                    <div class="author mt-3">
                        <h5>Rohan Das</h5>
                        <span>Father</span>
                    </div>
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Minimally invasive robotic surgery offers unmatched precision and rapid recovery. Schedule a consultation today.</p>
                    </div>
