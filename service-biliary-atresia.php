    ...
    <section class="section">
        <div class="container service-layout">
            <div class="service-main fade-in-up">
                <img src="assets/images/services/biliary-atresia.png" alt="Service Illustration" class="service-hero-image" style="width: 100%; height: auto; border-radius: var(--radius-md); margin-bottom: 30px; box-shadow: var(--shadow-sm); object-fit: cover; max-height: 400px;">
...
<h3 class="mt-4">Why Early Intervention Matters</h3>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-biliary-atresia.php" class="active">Biliary Atresia</a></li>
                </ul>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                <div class="testimonial-card card">
                    ...
                    <p class="quote">"Dr. Chowdhary's expertise in the Kasai procedure was a miracle for our baby. He explained the risks and benefits so clearly, and today our son is thriving."</p>
                ...
                <div class="testimonial-card card">
                    ...
                    <p class="quote">"The best decision for our child's liver health. The team at Apollo and Dr. Chowdhary are world-class. Our infant recovered remarkably well."</p>
                    <div class="author mt-3">
                        <h5>Sonia R.</h5>
                        <span>Mother</span>
                    </div>
    ...
    <section class="section">
        <div class="container grid-2 align-items-center">
            ...
            <div class="why-content fade-in-up" style="animation-delay: 0.2s">
                ...
                <p>Biliary Atresia surgery requires extreme precision in small infants. Experience in hepatobiliary reconstruction is the most important factor in a successful outcome.</p>
                <ul class="about-list">
            ...
            <div class="faq-accordion fade-in-up mt-5">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What is Biliary Atresia?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
                        <p>It is a rare childhood disease of the liver where the bile ducts are blocked, leading to bile buildup and liver damage.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-header">
                    ...
                    <div class="faq-content">
                        <p>It is the primary surgical treatment that bypasses the blocked bile ducts by connecting a loop of the small intestine directly to the liver.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What is the ideal age for the Kasai procedure?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
                        <p>It should ideally be performed before 60 days of age. Early surgery significantly improves the chance of restoring bile flow.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>Is a liver transplant always necessary?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
                        <p>While the Kasai procedure helps delay or avoid a transplant, many children with biliary atresia may eventually require a liver transplant later in childhood.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What are the main signs of biliary atresia?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
                        <p>Persistent jaundice beyond 2 weeks of life, pale or clay-colored stools, and dark urine are key red flags.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-header">
                    ...
                    <div class="faq-content">
                        <p>Typically, children stay in the hospital for 7 to 10 days for monitoring of bile drainage and nutritional support.</p>
                    </div>
                </div>
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>What postoperative care is needed?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
                        <p>Long-term follow-up involves nutritional supplements (fat-soluble vitamins), antibiotics to prevent cholangitis, and liver function monitoring.</p>
                    </div>
                </div>
            </div>
        </div>
