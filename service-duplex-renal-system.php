    ...
    <li><i class="fas fa-check-circle" style="color: var(--secondary-teal); margin-right: 8px;"></i> <strong>Kidney Swelling:</strong> Hydronephrosis or swelling in the upper part of the kidney.</li>
            ...
            <div class="sidebar fade-in-up" style="animation-delay: 0.2s">
                ...
                <ul class="sidebar-links">
                    ...
                    <li><a href="service-duplex-renal-system.php" class="active">Duplex Renal System</a></li>
        ...
        <div class="container relative z-10">
            ...
            <div class="scroll-container fade-in-up mt-5">
                ...
                <div class="testimonial-card card" style="animation-delay: 0.2s">
                    ...
                    <p class="quote">"Excellent explanation of the duplex renal system. Dr. Chowdhary's laparoscopic heminephrectomy saved the healthy part of our son's kidney."</p>
                    <div class="author mt-3">
                        <h5>Suresh N.</h5>
                        <span>Father</span>
                    </div>
    ...
    <section class="section bg-light" id="faq">
        <div class="container">
            ...
            <div class="faq-accordion fade-in-up mt-5">
                ...
                <div class="faq-item">
                    <div class="faq-header">
                        <h5>How is a duplex renal system diagnosed?</h5>
                        <i class="fas fa-plus"></i>
                    </div>
                    <div class="faq-content">
            ...
            <div class="grid-2 align-items-center">
                <div class="contact-form-wrapper card fade-in-up">
                    <div class="section-title text-left mb-4">
                        ...
                        <p>Most duplex kidneys need no treatment, but symptomatic cases deserve expert evaluation. Schedule a consultation today.</p>
                    </div>
